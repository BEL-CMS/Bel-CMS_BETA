								...
								<form action="Forum/send?management" method="post" class="form-horizontal">
									<fieldset>
										<div class="control-group">
											...
											<div class="controls">
												<label class="controls">
													<input name="title" class="span6" id="label_title" type="text" required="required" placeholder="Titre du forum" value="<?=$this->data->title?>">
												</label>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<label class="controls">
													<input name="subtitle" class="span6" id="label_subtitle" type="text" placeholder="Sous-titre du forum" value="<?=$this->data->subtitle?>">
												</label>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="controls">
													<input name="icon" class="span6" id="label_icon" type="text" placeholder="fa fa-code" value="<?=$this->data->icon?>"> <a target="_blank" href="http://fontawesome.io/icons/">icon</a>
												</label>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<label class="controls">
													<select name="id_forum" class="span6">
														<?php
														foreach ($this->data->forum as $v):
															$selected = $this->data->id_forum->id == $v->id ? 'selected="selected"': '';

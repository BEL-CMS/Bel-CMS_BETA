...
if ("teste" == false && AutoUser::isLogged() === true):
?>
<div id="teste"></div>
		...
		<div id="edit_profil_infos">
			...
			<form action="User/Send" method="post" enctype="multipart/form-data">
				...
				<div class="form-group input-icon-left">
					...
					<input class="form-control" name="birthday" type="date" value="<?=$data->birthday?>" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}">
				</div>

							...
							<form action="User/send?management" method="post" class="form-horizontal">
								<fieldset>
									<div class="control-group">
										...
										<div class="controls">
											<input name="MAX_USER" type="number" class="span6" id="label_nb" value="<?=$_SESSION['pages']->user->config['MAX_USER']?>" min="1" max="16">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="label_nb_admin"><?=NB_USER_ADMIN?></label>
										<div class="controls">
											<input name="MAX_USER_ADMIN" type="number" class="span6" id="label_nb_admin" value="<?=$_SESSION['pages']->user->config['MAX_USER_ADMIN']?>" min="1" max="25">
										</div>
									</div>
								</fieldset>
								<div class="form-actions">

...
?>
<div class="card">
	<div class="card-header"><i class="fa fa-align-justify"></i> <?=BLOG.' : '.ADD?></div>
		<form action="Blog/send?management" method="post" class="form-horizontal">
			<div class="card-body">
				<div class="form-group">
					...
					<div class="controls">
						<input name="name" type="text" class="form-control" id="label_name" placeholder="Nom de la page" required="required">
					</div>
				</div>
				<div class="form-group">
